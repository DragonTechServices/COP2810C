...
if(isset($_POST['Submit']))
{
	...
	$validator->addValidation("fName","alpha_s","First name should contain only letters");
	$validator->addValidation("lName","req","Please fill in a last name");
	$validator->addValidation("lName","alpha_s","Last name should contain only letters");
	$validator->addValidation("address","req","Please enter an address");
	$validator->addValidation("address","alnum_s","Address should only contain letters and numbers");
	$validator->addValidation("city","req","Please enter a city");
	$validator->addValidation("city","alpha","Please enter a city");
	$validator->addValidation("state","req","Please enter a state");
	$validator->addValidation("state","alpha","States should consist of letters only");
	$validator->addValidation("state","maxlen=2","Please enter a 2 letter state code");
	$validator->addValidation("state","minlen=2","Please enter a 2 letter state code");
